...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen place-items-center bg-background px-4 py-8 sm:px-6 lg:px-8">
      <section className="relative grid w-full max-w-6xl overflow-hidden rounded-[28px] border border-(--border) bg-(--surface) shadow-[0_28px_70px_-38px_rgba(15,39,73,0.55)] lg:min-h-155 lg:grid-cols-[0.92fr_1.08fr]">
